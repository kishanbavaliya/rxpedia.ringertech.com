...
var render = function render() {
  ...
  return _c('div', {
    ...
    attrs: {
      "label": _vm.$t('Drug_License_Number')
    }
  }, [_c('b-form-input', {
    attrs: {
      "label": "Drug License Number",
      "placeholder": _vm.$t('Drug_License_Number')
    },
    model: {
      value: _vm.client.drug_license_number,
      callback: function callback($$v) {
        _vm.$set(_vm.client, "drug_license_number", $$v);
      },
      expression: "client.drug_license_number"
    }
  })], 1)], 1), _vm._v(" "), _c('b-col', {
    attrs: {
      "md": "6",
    ...
    attrs: {
      "label": _vm.$t('FSSAI_License_Number')
    }
  }, [_c('b-form-input', {
    attrs: {
      "label": "FSSAI License Number",
      "placeholder": _vm.$t('FSSAI_License_Number')
    },
    model: {
      value: _vm.client.fssai_license_number,
      callback: function callback($$v) {
        _vm.$set(_vm.client, "fssai_license_number", $$v);
      },
      expression: "client.fssai_license_number"
    }
  })], 1)], 1), _vm._v(" "), _c('b-col', {
    attrs: {
      "md": "6",
